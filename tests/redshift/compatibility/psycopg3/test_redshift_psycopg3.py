...
def test_full_refresh(
    conn: psycopg.Connection, adapter: RedshiftAdapter, registry: SchemaRegistry, src_table: Table, tgt_table: Table
) -> None:
...
def test_delete_insert_target_table_does_not_exist(
    conn: psycopg.Connection, adapter: RedshiftAdapter, src_table: Table, tgt_table: Table
) -> None:
...
def test_merge(conn: psycopg.Connection, adapter: RedshiftAdapter, registry: SchemaRegistry, src_table: Table, tgt_table: Table) -> None:
    tgt_table.insert([(1, "2024-01-01", 10), (2, "2024-01-01", 20)])
...
def test_full_refresh_rollback_on_error(
    conn: psycopg.Connection, adapter: RedshiftAdapter, registry: SchemaRegistry, tgt_table: Table
) -> None:
