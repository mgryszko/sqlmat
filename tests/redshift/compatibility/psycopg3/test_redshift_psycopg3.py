...
def test_full_refresh(conn: psycopg.Connection, executor: Executor, registry: SchemaRegistry, src_table: Table, tgt_table: Table) -> None:
...
def test_merge(conn: psycopg.Connection, executor: Executor, registry: SchemaRegistry, src_table: Table, tgt_table: Table) -> None:
    tgt_table.insert([(1, "2024-01-01", 10), (2, "2024-01-01", 20)])
