...
def test_unload_events(
    adapter: RedshiftAdapter, registry: SchemaRegistry, src_table: Table, events: list[Event], unload_s3_uri: str, redshift_env: RedshiftEnv
) -> None:
...
def test_unload_error_events(adapter: RedshiftAdapter, events: list[Event], unload_s3_uri: str, redshift_env: RedshiftEnv) -> None:
