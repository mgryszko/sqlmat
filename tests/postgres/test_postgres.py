...
def test_append_target_table_does_not_exist(conn: psycopg.Connection, adapter: PostgresAdapter, src_table: Table, tgt_table: Table) -> None:
...
def test_append_rollback_on_error(conn: psycopg.Connection, adapter: PostgresAdapter, registry: SchemaRegistry, tgt_table: Table) -> None:
